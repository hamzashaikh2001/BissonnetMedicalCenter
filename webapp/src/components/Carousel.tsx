    ...
    return (
        <div className="carousel h-screen w-full">
            <div id="item1" className="carousel-item w-full">
                <Image src="/Slides/Slide1.webp" alt="Doctor with a stethoscope" width="1520" height="740" sizes="100vw" className="w-full h-auto pt-20" />
            </div>
            <div id="item2" className="carousel-item w-full">
                <Image src="/Slides/Slide2.webp" alt="Doctor talking to a patient" width="1520" height="740" sizes="100vw" className="w-full h-auto pt-20" />
            </div>
            <div id="item3" className="carousel-item w-full">
                <Image src="/Slides/Slide3.webp" alt="Doctor taking vitals" width="1520" height="740" sizes="100vw" className="w-full h-auto pt-20" />
            </div>
            <div id="item4" className="carousel-item w-full">
                <Image src="/Slides/Slide4.webp" alt="Organized Clinic Office" width="1520" height="740" sizes="100vw" className="w-full h-auto pt-20" />
            </div>
