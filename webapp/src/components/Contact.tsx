    ...
    return (
        <div id="contact" className="flex min-h-screen flex-col pt-28 space-y-6 bg-white">
            ...
            <div className="flex flex-col lg:flex-row items-center w-full text-white">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3466.5682662450795!2d-95.5787357!3d29.674300100000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640dd5e4b7ea63f%3A0x9ed33066f5fbaf93!2sBissonnet%20Medical%20Center!5e0!3m2!1sen!2sus!4v1696726547260!5m2!1sen!2sus" width="100%" height="539" style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                <div className="min-w-max w-screen lg:w-1/3 lg:px-20 py-16 bg-purple-800 flex flex-col items-center lg:items-start space-y-6">
