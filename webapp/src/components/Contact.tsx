...
const Contact = () => {
    return (
        <div id="contact" className="flex min-h-screen flex-col items-center p-28 space-y-6 bg-primary-content text-black">
            <h2 className="text-4xl font-bold">Contact Us</h2>
            <h3 className="text-2xl">Get in contact with us!</h3>
            <div className="flex flex-col lg:flex-row-reverse items-center justify-evenly w-full space-y-10 lg:space-y-0">
                ...
                <div className="card min-w-max w-2/5 bg-slate-300 items-center text-center shadow-xl">
                    <div className="card-body">
                        ...
                        <div className="flex w-80 justify-evenly">
                            <a className="btn btn-info hover:bg-blue-700" href="tel:2815756700">(281) 575-6700</a>
                            <a className="btn btn-info hover:bg-blue-700" href="mailto:BissonnetMedicalCenter@yahoo.com">Our Email</a>
                        </div>
                    </div>
                </div>
            </div>        
