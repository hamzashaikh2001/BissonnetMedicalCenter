...
const Contact = () => {
    return (
        <div id="contact" className="flex min-h-screen flex-col pt-28 space-y-6 bg-primary-content">
            ...
            <div className="flex flex-col lg:flex-row items-center w-full space-y-10 lg:space-y-0 text-white">
                ...
                <div className="min-w-max w-1/3 px-20 py-16 bg-purple-600 items-center space-y-6">
                    ...
                    <div className="flex w-64 justify-between">
                        <a className="btn bg-purple-800 hover:bg-purple-900 text-white" href="tel:2815756700">(281) 575-6700</a>
                        <a className="btn bg-purple-800 hover:bg-purple-900 text-white" href="mailto:BissonnetMedicalCenter@yahoo.com">Our Email</a>
                    </div>
                </div>
            </div>        
        </div>
